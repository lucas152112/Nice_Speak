...
| 1.3 | 初始化 Vue.js 3 專案 | 建立 web/ 目錄 | - | ⏳ |
| 1.4 | 初始化 Rust 後端 | 建立 backend/ 目錄 | - | ⏳ |
| 1.5 | 資料庫遷移腳本 | 建立 PostgreSQL 表結構 | 1.4 | ⏳ |
| 1.6 | 後端配置管理 | config.rs 實作 | 1.4 | ⏳ |
| 1.7 | JWT 認證模組 | 登入/註冊/Token 刷新 | 1.4, 1.5 | ⏳ |
| 1.8 | 用戶 CRUD API | 個人資料管理 | 1.7 | ⏳ |
| 1.9 | 前端 API 服務層 | Axios + API 封裝 | 1.2, 1.3 | ⏳ |
| 1.10 | 前端認證頁面 | 登入/註冊頁面 | 1.9, 1.8 | ⏳ |

### 單元測試範圍

| # | 測試項目 | 測試內容 |
|---|----------|----------|
| 1.7.1 | JWT 產生 | Token 格式驗證 |
| 1.7.2 | JWT 驗證 | Token 有效性檢查 |
| 1.7.3 | 密碼加密 | bcrypt 雜湊比對 |
| 1.8.1 | 用戶創建 | 必填欄位驗證 |
| 1.8.2 | 用戶查詢 | 權限檢查 |
